...
export function CharacterModal({
  ...
  return (
    ...
    >
      <div
        className={`rounded-2xl p-6 max-w-4xl w-full mx-4 mt-[227px] md:mt-0 bg-gray-900 flex flex-col md:flex-row gap-6 ${getBgColorBySpecies(
          character.species
        )}`}
      ...
      >
        ...
        <div className="md:w-2/3 flex flex-col space-y-4">
          <div className="flex-grow">
            ...
            <div className="flex gap-8 mt-4 text-sm leading-relaxed">
              {/* List of Films */}
              <div className=" w-1/2">
                ...
                <div className="flex flex-col mt-1 space-y-1">
                  {character.films.map((film: string, index: number) => (
                    <span
                      className="text-grey-600 transition-colors"
                      key={index}
                    >
                      {film}
                    </span>
